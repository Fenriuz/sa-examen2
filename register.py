...
class Register :
     def __init__(self,window,connect) :
         ...
         submit = Button(self.window, text="registrarse", fg="Black", bg="Green",foreground="White",command=lambda:connect.insertUser(self.textUser.get(),self.textPass.get(),self.table)) 
